...
namespace Var2
{
    public partial class Books : Form
    {
        ...
        {
            Книги product = (Книги)книгиBindingSource.Current;
            Change change = new Change();
            DialogResult = change.ShowDialog();
        ...
        {
            Книги product = (Книги)книгиBindingSource.Current;
            DialogResult dr = MessageBox.Show("Вы действительно хотите удалить книгу? - " + product.Наименование,
                "Удаление книги", MessageBoxButtons.YesNo,
                MessageBoxIcon.Question);
            if (dr == DialogResult.Yes)
            {
                Program.db.Книги.Remove(product);
                try
                {
